...
import { PlexSection } from '@/components/settings/sections';
import type { AppSettings } from '@/lib/types/settings';

const PlexSettingsPage: React.FC = () => {
  const { 
    settings, 
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Plex Integration</h1>
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Configure Plex Media Server connection and integration settings.
        </p>
      </div>
